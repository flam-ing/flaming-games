...
> Chiptune WebAudio 사운드, 절차적 픽셀 아트, Three.js 3D 복셀 렌더러 등 외부 에셋 없이 순수 웹 브라우저 기술로만 설계된 8가지 시그니처 플라밍고 게임들이 수록되어 있습니다.
...
graph TD
    ...
    A --> G["6. Flamingo Empress (궁정 시뮬레이션)"]
    A --> H["7. Flamingo Craft (3D 마인크래프트)"]
    A --> I["8. Flamingo Gate Defense (3D 러너 디펜스)"]
```
...
### 8. 🛡️ [Flamingo Gate Defense](./flamingo-gate-defense)
